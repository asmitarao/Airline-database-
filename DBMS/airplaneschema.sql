...
/*create table seat(
		...
		arrival_aiport_code varchar(10) , 
		...
		foreign key(p_id) references passengers on delete cascade ,
...
create table reservation(
		...
		foreign key(departure_airport_code) references airport(airport_code) on delete cascade, 
		foreign key(flight_number) references flight(flight_number) on delete cascade, 
		primary key(p_id,seat_number,ldate,flight_number,leg_no,departure_airport_code,arrival_airport_code)
		); 
...
insert into passenger values ('0011231298', '19B', 'abc', '919234156708', 'abc@gmail.com');
insert into passenger values ('0013456211', '1A', 'aQc', '729234156708', 'aQc@gmail.com');
insert into passenger values ('0023937830', '6C', 'xstc', '811237156708', 'xstc@gmail.com');
insert into passenger values ('0012211981', '34D', 'xyq', '949234156708', 'xyq@gmail.com');
insert into passenger values ('0047621120', '12A', 'xyz', '939982535608', 'xyz@gmail.com');
